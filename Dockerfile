...
COPY pyproject.toml uv.lock* /usr/src/langchain_ai_skills_framework/
...
COPY --from=python_packages /usr/src/langchain_ai_skills_framework/uv.lock ${PROJECT_DIR}/uv.lock
